...
@Component({
  selector: 'app-index-dubai-club',
  templateUrl: './index-dubai-club.component.html',
  styleUrls: ['./index-dubai-club.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class IndexDubaiClubComponent implements OnInit {
